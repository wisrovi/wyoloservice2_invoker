...
| **Worker Invoker** | `wisrovi/train_service:worker_invoker_v1.3.0` | Celery worker that manages Docker containers |
...
# Worker Invoker
docker build -t wisrovi/train_service:worker_invoker_v1.3.0 ./wyoloservice2_invoker
...
docker build -t wisrovi/train_service:w_darwin_ops_frontend_v1.1.0 ./NeuralForgeAI/UI
...
services:
  ...
  worker:
    image: wisrovi/train_service:worker_invoker_v1.3.0
